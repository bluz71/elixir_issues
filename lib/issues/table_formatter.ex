defmodule Issues.TableFormatter do
  ...
  extracted and printed from the rows. We calculate the width of each column to
  fit the longest element in that column.
  """
  ...
  defp puts_one_line_in_colums(fields, format) do
